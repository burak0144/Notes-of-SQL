...
--exist'te ikinci tablodan veri select ederken iki tablonun degerlerini esitlemeliyiz(where ile)
...
select urun_isim as ortak_satilan_urunismi,musteri_isim as nisan_ayinda_satin_alan_musteri from nisan
where exists (select urun_isim from mart where mart.urun_isim=nisan.urun_isim)

--Her iki ayda ortak satilmayan ürünlerin URUN_ISIM'lerini ve  bu ürünleri
--NİSAN ayında satın alan MUSTERI_ISIM'lerini listeleyen bir sorgu yazınız.
select urun_isim as iki_ayda_ortak_satilmayan_urunler,musteri_isim as nisan_ayinda_alan_musteri from nisan
