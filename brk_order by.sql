...
-- sıralama yapmak için kullanılır asc -->natural siralama yapar
-->desc ise tersten siralama yapar
...
select*from kisiler order by adres asc --ASCANDING yazmasakta ayni sonucu verir

-- kisiler tablosunu adres'e göre tersten sıralayarak sorgulayınız.
select*from kisiler order by adres desc --tersten siralar
...
--soyismi Bulut olanlarin maasini siralayin
