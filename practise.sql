...
(                                                                                             
id serial primary key  ,   --seral id yi auto increment gibi otomatik arttirir                                                                   
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
-- 9) email adresi @gmail.com olan personel bilgilerini listeleyiniz
select*from personel where email ~* '@gmail.com'

-- 10) email adresi gmail olmayan personel bilgilerini listeleyiniz.
select*from personel where email !~ '@gmail.com' -- deger aramasi yapildigi icin null gelmez
