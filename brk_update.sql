--Update DML,veri uzerinde degisiklik yapilir,gucncelleme dendiginde update anlamaliyiz
...
drop table tedarikciler cascade
--  vergi_no’su 102 olan tedarikcinin firma ismini 'Vestel' olarak güncelleyeniz.(Update)
UPDATE tedarikciler Set firma_ismi='Vestel' where vergi_no=102; 
--(update degistirecegin tablo,set degistirecegin sutun,where sart koyulan sutun)
