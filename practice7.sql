...
select f.film_name,f.category,a.actor_name from films as f
left join actors as a
on f.film_id=a.film_id;

-- SORU2: Tüm aktorleri, film türlerini ve filmlerde oynayan aktörleri listeleyiniz.
select a.actor_name,f.film_name,f.category 
from actors a left join films f
